...
namespace PROYECTO_FINAL
{
    public partial class FAsignaciones : Form
    {
        ...
        public FAsignaciones()
        {
            ...
            cbxDestino.KeyPress += cbxDestino_KeyPress;
            cbxProducto.KeyPress += cbxProducto_KeyPress;
        ...
        public void StockActual(DataGridView dvg)
        {
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("SELECT NombreProducto, CantidadDetalle FROM detallestock WHERE CodSucursal = '{0}'", cbxOrigen.Text), BDcomun.ObtenerConexion());
        ...
        private void cbxDestino_KeyPress(object sender, KeyPressEventArgs e)
        {
