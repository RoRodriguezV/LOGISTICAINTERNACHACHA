...
namespace PROYECTO_FINAL
{
    public partial class FRECETA : Form
    {
        public FRECETA()
        {
            ...
            ComboBoxIngrediente.KeyPress += ComboBoxIngrediente_KeyPress;
        ...
        private void btseleccionar_Click_1(object sender, EventArgs e)
        {
        ...
        private void ComboBoxIngrediente_KeyPress(object sender, KeyPressEventArgs e)
        {
            ComboBoxIngrediente.DropDownStyle = ComboBoxStyle.DropDownList;
        }
