...
namespace PROYECTO_FINAL
{
    public partial class FBuscarInsumo : Form
    {
        ...
        {
            InitializeComponent();
            cbxInsumo.KeyPress += cbxInsumo_KeyPress;
        ...
        private void cbxInsumo_KeyPress(object sender, KeyPressEventArgs e)
        {
            cbxInsumo.DropDownStyle = ComboBoxStyle.DropDownList;
        }
    }
}
